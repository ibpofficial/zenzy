...
export default function MeetingChatPage() {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-slate-50 via-white to-slate-50 flex flex-col font-sans overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 flex flex-col bg-gradient-to-b from-slate-50/30 to-white h-full relative overflow-hidden">
          {/* Header Bar with Title Heading (shown on both mobile and PC) */}
          <div className="flex items-center justify-between px-4 sm:px-6 py-3 bg-white/80 backdrop-blur-md border-b border-slate-200/60 z-40 shrink-0">
            <div className="flex items-center gap-3">
              ...
              <motion.button
                ...
                className="md:hidden p-2.5 hover:bg-slate-100 rounded-xl text-slate-600 hover:text-slate-900 transition-all"
              ...
              <div className="text-left">
                ...
                <p className="hidden md:flex text-[10px] text-slate-400 font-medium mt-0.5 items-center gap-2">
            ...
            {/* Back button (mobile only, since desktop has it in the sidebar) */}
            <div className="md:hidden flex items-center">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => router.back()}
                className="p-2.5 hover:bg-slate-100 rounded-xl text-slate-600 hover:text-slate-900 transition-all"
                aria-label="Back"
              >
                <ArrowLeft className="w-5 h-5" />
              </motion.button>
          ...
          {/* Messages Feed */}
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 pt-4 md:pt-6 space-y-4 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
            <AnimatePresence>
              {messages.length === 0 ? (
                <motion.div
