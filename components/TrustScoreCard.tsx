...
export default function TrustScoreCard({
  ...
  return (
    <div className="bg-white/80 backdrop-blur-md border border-slate-200/80 p-6 sm:p-8 rounded-lg shadow-lg relative overflow-hidden w-full text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        ...
        <div className="md:col-span-8 flex flex-col gap-4 items-start text-left w-full">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4.5 py-2.5 rounded-lg bg-slate-50 hover:bg-slate-105 border border-slate-200 text-slate-700 font-black text-[10px] uppercase tracking-wider transition cursor-pointer select-none active:scale-97 shrink-0 shadow-xs"
          >
            ...
            <div className="w-full pt-2 animate-fade-in">
              {factors ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                  ...
                  <div className="bg-slate-50/50 p-3.5 rounded-lg border border-slate-100/60 flex flex-col justify-between">
        ...
        <div className="mt-8 pt-6 border-t border-slate-200/80 animate-fade-in">
          ...
          <div className="space-y-3.5">
            {suggestions.map((sug: any, idx: number) => (
              <div
                key={idx}
                className="flex items-center justify-between p-3.5 bg-indigo-50/40 border border-indigo-100/50 rounded-lg hover:bg-indigo-50 transition"
              >
